 ...
 * 
 */
public class WifiHotspotAdapter {
	...
	public WifiHotspotAdapter(WifiManager mgr) {
		this.mgr = mgr;
	}

	public static WifiHotspotAdapter getApControl(WifiManager mgr) {
		if (!isApSupported())
			return null;
		return new WifiHotspotAdapter(mgr);
	}
	...
	public  void turn(Context context, boolean isTurnToOn) {
		WifiManager wifiManager = (WifiManager) context
				.getSystemService(Context.WIFI_SERVICE);
		WifiHotspotAdapter apControl = WifiHotspotAdapter.getApControl(wifiManager);
		if (apControl != null) {
